...
# ------------------------
echo "####### Enabling JMX and Prometheus metrics setup #######" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "java.arg.101=-Dcom.sun.management.jmxremote.local.only=true" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "java.arg.102=-Dcom.sun.management.jmxremote" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "java.arg.103=-Dcom.sun.management.jmxremote.authenticate=false" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "java.arg.104=-Dcom.sun.management.jmxremote.ssl=false" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "java.arg.104=-Dcom.sun.management.jmxremote.port=30007" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "java.arg.105=-javaagent:/opt/nifi/nifi-1.9.0/lib/jmx_prometheus_javaagent-0.3.1.jar=8079:/tmp/prometheus_jmx_exporter.yml" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
echo "####### Enabling JMX and Prometheus metrics setup #######" >> /opt/nifi/nifi-1.9.0/conf/bootstrap.conf
# ------------------------
